<div class="panel panel-headline">
	...
	<div class="panel-body">
		<div class="row">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-md"><span class="fa fa-plus"></span> Tambah Perusahaan</button>
			      	...
			      	<form method="post" action="<?=base_url('index.php');?>/admin/add_admin">
				        ...
				        <div class="modal-body">
				        	<div class="panel-body">
					          	...
					          	<div class="form-group">
					          		<input type="text" name="nama_user" placeholder="Nama Perusahaan" class="form-control">
					          	</div>
					          	<div class="form-group">
