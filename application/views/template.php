...
<head>
	<title>Dashboard | Ker-Join - Semangat mencari cuan yang halal yan teman!</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						<?php
							...
							?>
								...
								<li>
									<a href="<?=base_url('index.php');?>/masakan" <?php if($main_menu == 'masakan'):?>class="active"<?php endif;?>><i class="lnr lnr-code"></i> <span>Lowongan</span></a>
								</li>

								<li>
									<a href="<?=base_url('index.php');?>/pelanggan/list_pelanggan" <?php if($main_menu == 'pelanggan'):?>class="active"<?php endif;?>><i class="lnr lnr-code"></i> <span>Pendaftar</span></a>
								</li>
								<li>
									<a href="<?=base_url('index.php');?>/transaksi" <?php if($main_menu == 'transaksi'):?>class="active"<?php endif;?>><i class="lnr lnr-code"></i> <span>Rekrutmen</span></a>
								</li>
